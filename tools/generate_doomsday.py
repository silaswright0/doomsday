...
def write_loc(countries: dict[str, dict], tags: list[tuple[str, str]]):
    ...
    LEADER_DESCS = {
        "USA": "Donald Trump is back in the White House for a second term, pressing the border, tariffs, and the agencies under a tighter presidency.",
        "CHI": "Xi Jinping remains general secretary, president, and chairman of the central military commission. The party sets the line.",
        "SOV": "Vladimir Putin remains president. The security ministries and the presidential administration run the state around him.",
        "RAJ": "Narendra Modi is prime minister. The BJP holds the centre of Indian politics, and the prime minister's office holds the government.",
        "ENG": "Keir Starmer is prime minister after Labour's 2024 victory, running a tight fiscal line with a party less united than its majority.",
        "FRA": "Emmanuel Macron is still president, deep in his second term, and still without a reliable majority in the National Assembly.",
        "GER": "Friedrich Merz is chancellor of a CDU-led coalition, more Atlanticist and tighter on spending than the government he replaced.",
        "JAP": "Shigeru Ishiba is prime minister, leading a weaker LDP through a defence build-up aimed at China and North Korea.",
        "ITA": "Giorgia Meloni is prime minister. Brothers of Italy holds the coalition, hard on migration and conventional on the Atlantic alliance.",
        "CAN": "Mark Carney is prime minister, trying to hold the federation together on trade, housing, and the American relationship.",
        "KOR": "Lee Jae-myung is president, balancing the American alliance, a wary China, and a North Korea that has not slowed its missiles.",
        "DPK": "Kim Jong-un rules through the party, the army, and the family. The nuclear force is the regime's guarantee.",
        "BRA": "Luiz Inacio Lula da Silva is in his third presidency, leaning on a broad and fractious coalition in Congress.",
        "MEX": "Claudia Sheinbaum is president, continuing Morena's hold on the executive with a large bloc in Congress and a tense line toward Washington.",
        "INS": "Prabowo Subianto is president. The former general runs a broad cabinet and keeps the army close to civilian administration.",
        "TUR": "Recep Tayyip Erdogan remains president. The palace, not the parliament, is the centre of Turkish decisions.",
        "SAU": "Mohammed bin Salman is crown prince and prime minister. Vision 2030 and the security services both answer to him.",
        "AST": "Anthony Albanese is prime minister. Labor governs with a cautious line on China and the American alliance.",
        "SPR": "Pedro Sanchez remains prime minister of a minority government that survives by deals with regional parties.",
        "POL": "Donald Tusk is prime minister of the coalition that unseated Law and Justice, and is still fighting it over the courts.",
        "HOL": "Dick Schoof is prime minister of a right-leaning cabinet formed after the PVV's election shock.",
        "BEL": "Bart De Wever is prime minister, a Flemish nationalist trying to hold a divided Belgian coalition together.",
        "SWE": "Ulf Kristersson is prime minister, dependent on Sweden Democrat support for a stricter line on migration and crime.",
        "NOR": "Jonas Gahr Store is prime minister. Labour governs a wealthy oil state that argues over how far to spend it.",
        "DEN": "Mette Frederiksen is prime minister. The Social Democrats keep a hard migration line and a firm place in NATO.",
        "GRN": "Jens-Frederik Nielsen leads Greenland's government while Copenhagen and Washington both press on the island's future.",
        "FIN": "Petteri Orpo is prime minister. Finland is inside NATO, and the coalition is built to pay for that.",
        "SWI": "Viola Amherd sits on the Federal Council. The presidency rotates each year, and the council governs, not one person.",
        "AUS": "Christian Stocker is chancellor of a coalition assembled after a fractured election.",
        "IRE": "Simon Harris is taoiseach. Fine Gael leads a government still arguing over housing.",
        "POR": "Luis Montenegro is prime minister of a centre-right government with a thin margin in parliament.",
        "GRE": "Kyriakos Mitsotakis is prime minister. New Democracy holds a clear majority and a pro-NATO line.",
        "CZE": "Petr Fiala is prime minister of a centre-right coalition that has made Ukraine and the budget its tests.",
        "SLO": "Robert Fico is prime minister again, at the head of a coalition that slowed aid to Ukraine and fought the press.",
        "HUN": "Viktor Orban remains prime minister. Fidesz controls the state, the media environment, and foreign policy.",
        "ROM": "Ilie Bolojan is prime minister, trying to hold a pro-European cabinet together.",
        "BUL": "Rosen Zhelyazkov is prime minister of a fragile coalition in a country that has burned through governments.",
        "SER": "Aleksandar Vucic is president, and the real centre of power. The prime minister's office follows the presidency.",
        "CRO": "Andrej Plenkovic is prime minister. HDZ has governed long enough that the state and the party are hard to separate.",
        "SLV": "Robert Golob is prime minister of the liberal coalition that replaced Janez Jansa.",
        "BOS": "Denis Becirovic is the Bosniak member of the presidency. The state still turns on three peoples and a foreign high representative.",
        "MAC": "Hristijan Mickoski is prime minister, returning VMRO-DPMNE on a nationalist ticket.",
        "ALB": "Edi Rama is prime minister, as he has been for more than a decade. The Socialist Party's machine is the government.",
        "MNT": "Milojko Spajic is prime minister of a small pro-European government still split over Serbia and the church.",
        "KOS": "Albin Kurti is prime minister. Vetevendosje treats the dialogue with Belgrade as something to endure, not to rush.",
        "UKR": "Volodymyr Zelenskyy is president of a country at war. Martial law has suspended the election that would otherwise have been held.",
        "BLR": "Alexander Lukashenko remains president. The security organs, not the ballot, keep him there.",
        "EST": "Kristen Michal is prime minister. Estonian politics are built around the Russian threat and a thin fiscal margin.",
        "LAT": "Evika Silina is prime minister of a coalition that treats Russia as the main fact of Latvian security.",
        "LIT": "Gintautas Paluckas is prime minister. Lithuania stays one of Kyiv's firmest backers.",
        "MOL": "Maia Sandu is president. The government is pro-European, and Transnistria remains a Russian-held problem on the river.",
        "PMR": "Vadim Krasnoselsky presides over a strip of land that exists because Russian troops are still there.",
        "GEO": "Irakli Kobakhidze is prime minister. Georgian Dream holds the state and has cooled the European track.",
        "ABK": "Badra Gunba leads Abkhazia under Russian protection. Sukhumi is not a Georgian government.",
        "SOE": "Alan Gagloev leads South Ossetia, a Russian garrison with a local presidency attached.",
        "ARM": "Nikol Pashinyan is prime minister, still in office after the 2020 defeat and the loss of Nagorno-Karabakh.",
        "AZR": "Ilham Aliyev is president. The 2023 recovery of Karabakh settled the war on Baku's terms.",
        "KAZ": "Kassym-Jomart Tokayev is president, balancing Moscow, Beijing, and his own security services.",
        "UZB": "Shavkat Mirziyoyev is president, opening the economy without opening the political system.",
        "TMS": "Serdar Berdimuhamedow is president in name. The family, and his father, still sit over the gas state.",
        "KYR": "Sadyr Japarov is president, a populist who concentrated power after the 2020 uprising.",
        "TAJ": "Emomali Rahmon has been president since the civil war. A family succession is the only transition under discussion.",
        "MON": "Khurelsukh Ukhnaa is president. Mongolia balances Chinese trade against a careful distance from Moscow.",
        "PAK": "Shehbaz Sharif is prime minister. The army remains the institution that decides how long a civilian government lasts.",
        "BAN": "Muhammad Yunus heads the interim government installed after Hasina's fall. An election is supposed to come next.",
        "BRM": "Min Aung Hlaing is the junta's commander. The army holds the cities. It does not hold the country.",
        "NUG": "Duwa Lashi La is acting president of the National Unity Government, the civilian claim against the junta.",
        "SIA": "Paetongtarn Shinawatra is prime minister, the latest Shinawatra face on a government the palace and the army still watch.",
        "MAL": "Anwar Ibrahim is prime minister of a unity government he spent decades trying to reach.",
        "VIN": "To Lam leads the party and the state. Vietnam's succession is a politburo decision, not an election.",
        "PHI": "Ferdinand Marcos Jr is president, a dynasty's return with a firm American security line and a cautious China policy.",
        "SNG": "Lawrence Wong is prime minister, the PAP's managed succession from Lee Hsien Loong.",
        "FOR": "Lai Ching-te is president. The DPP holds the office, and Beijing treats that as a provocation.",
        "CAM": "Hun Manet is prime minister, his father's successor. The party and the army did not change when the name did.",
        "LAO": "Thongloun Sisoulith is president and party chief of a one-party state deep in Chinese debt.",
        "NEP": "K.P. Sharma Oli is prime minister again, balancing India, China, and a parliament that rarely sits still.",
        "BHU": "Tshering Tobgay is prime minister. The king remains the centre of the Bhutanese state.",
        "SRL": "Anura Kumara Dissanayake is president, a left nationalist elected on the wreckage of the 2022 collapse.",
        "AFG": "Hibatullah Akhundzada is supreme leader. The emirate is clerical rule from Kandahar, not a cabinet in Kabul.",
        "NRF": "Ahmad Massoud leads the National Resistance from the Panjshir and from exile. It is an armed claim, not a government in Kabul.",
        "PER": "Masoud Pezeshkian is president. The supreme leader, not the president, decides war, the nuclear file, and the Guards.",
        "IRQ": "Mohammed Shia al-Sudani is prime minister, a Coordination Framework choice trying to keep militias and Americans in one state.",
        "KUR": "Masrour Barzani is prime minister of the Kurdistan Region. Erbil runs its own oil, peshmerga, and argument with Baghdad.",
        "SYR": "Ahmed al-Sharaa leads Syria after Assad's fall. The former HTS command is now the government in Damascus.",
        "ROJ": "Mazloum Abdi commands the SDF. Rojava's autonomy depends on an American presence and a hostile Damascus.",
        "DRZ": "Hikmat al-Hijri is the Druze lead in Suwayda. The province is armed and is not taking orders from Damascus.",
        "SNA": "Fadlallah al-Hajji leads the Syrian National Army, Turkish-backed factions on the northern border, not a Damascus ministry.",
        "LEB": "Joseph Aoun is president, a former army commander elected to put a state back over a country of militias.",
        "HEZ": "Naim Qassem leads Hezbollah after Nasrallah's death. The party is weaker, still armed, and still outside the cabinet's control.",
        "JOR": "Abdullah II is king. The prime minister serves at his pleasure, and the security services are the real government.",
        "ISR": "Benjamin Netanyahu is prime minister of a right-religious coalition, still at war on more than one front.",
        "PAL": "Mahmoud Abbas presides over a Palestinian Authority that administers fragments of the West Bank and does not control Gaza.",
        "HAM": "Khalil al-Hayya speaks for Hamas's political office. The movement still holds Gaza and is not the Ramallah authority.",
        "EGY": "Abdel Fattah el-Sisi is president. The army is the economy, and the electorate is not the constraint.",
        ...
        "TUN": "Kais Saied is president, ruling by decree after he closed the old parliament and wrote a constitution around himself.",
        "ALG": "Abdelmadjid Tebboune is president. The army and the security services remain the partners that matter.",
        "MOR": "Mohammed VI is king. The head of government administers. The palace decides.",
        "WES": "Brahim Ghali leads the Polisario. The Sahrawi claim is a camp at Tindouf and a diplomatic file, not a capital in Laayoune.",
        "SAF": "Cyril Ramaphosa is president of an ANC that no longer governs alone and has had to share the cabinet.",
        "LES": "Letsie III is king. The prime minister governs a poor enclave inside South Africa, and the palace is the referee.",
        "SWZ": "Mswati III is an absolute king. Parties are banned, and the government is the monarchy.",
        "NGA": "Bola Tinubu is president, bringing Lagos-machine politics to Abuja along with a subsidy crisis and a restless north.",
        "ETH": "Abiy Ahmed is prime minister at the centre of a federation that has already fought one war and is managing others.",
        "KEN": "William Ruto is president, elected against the old dynasties and now governing through a broad, transactional coalition.",
        "GHA": "John Mahama is president again, returned by voters after the NPP's term.",
        "COG": "Felix Tshisekedi is president. Kinshasa holds the title. The east is a war with M23 and several armies.",
        "M23": "Corneille Nangaa fronts the M23 alliance. The rifles in North Kivu are the movement, and Kigali's role is the open argument.",
        "ANG": "Joao Lourenco is president, the MPLA's successor to dos Santos, still running a party-state on oil.",
        "MZB": "Daniel Chapo is president, FRELIMO's latest nominee. The Cabo Delgado insurgency did not end with the succession.",
        "ZIM": "Emmerson Mnangagwa is president. ZANU-PF and the army remain the succession that matters.",
        "SUD": "Abdel Fattah al-Burhan commands the army and what remains of the Khartoum government, at war with the RSF.",
        ...
        "SSD": "Salva Kiir is president. The peace agreement is a ceasefire between armed parties, not a settled state.",
        ...
        "SOM": "Hassan Sheikh Mohamud is president in Mogadishu. The federal government does not control most of the countryside.",
        "SML": "Abdirahman Mohamed Abdullahi is president of Somaliland, a working administration that almost nobody recognizes.",
        "PNT": "Said Abdullahi Deni is president of Puntland, autonomous from Mogadishu and fighting al-Shabaab on his own account.",
        "JUB": "Ahmed Madobe is president of Jubaland, holding Kismayo with his own forces and a difficult line to Mogadishu.",
        "SHB": "Ahmed Diriye leads al-Shabaab, an insurgency with taxation and courts and no interest in the federal constitution.",
        "UGA": "Yoweri Museveni has been president since 1986. The army and the family are the succession plan.",
        "TZN": "Samia Suluhu Hassan is president, CCM's successor to Magufuli, looser on the press and no looser on the party.",
        "RWA": "Paul Kagame is president. The RPF's victory margins are not how the state is actually held.",
        "SEN": "Bassirou Diomaye Faye is president, with Ousmane Sonko as the partner who brought the youth vote in.",
        "IVO": "Alassane Ouattara is president again, past the term the opposition said he should not have had.",
        "CMR": "Paul Biya is president, as he has been since 1982. The palace in Yaounde is the government.",
        "MLI": "Assimi Goita is the junta's president. French forces are gone. The northern war remains.",
        ...
        "NGR": "Abdourahamane Tchiani leads the junta that removed Bazoum. The uranium and the French base both changed hands.",
        "CHA": "Mahamat Deby is president, his father's successor after a battlefield death and a managed election.",
        "ARG": "Javier Milei is president, cutting the state with a minority in Congress and a monthly fight over the peso.",
        "CHL": "Gabriel Boric is president of a left government that has had to govern with a congress it does not control.",
        "COL": "Gustavo Petro is president, negotiating with armed groups and a hostile congress.",
        "PRU": "Dina Boluarte is president, in office since Castillo's removal and governing without a strong party of her own.",
        "VEN": "Nicolas Maduro is president. The election is disputed, the oil is sanctioned, and the party and the army hold Caracas.",
        "BOL": "Luis Arce is president, MAS in office and split from Evo Morales.",
        "ECU": "Daniel Noboa is president, governing through a security emergency against the gangs.",
        "URG": "Yamandu Orsi is president, returning the Broad Front after Lacalle Pou's term.",
        "PAR": "Santiago Pena is president. The Colorado Party is the state it has usually been.",
        "CUB": "Miguel Diaz-Canel is president. The party and the armed forces are the government. The presidency is the face.",
        "DOM": "Luis Abinader is president, re-elected, with a pro-business line and a hard policy on Haiti.",
        "HAI": "A transitional presidential council holds the title in Port-au-Prince. Gangs hold much of the city.",
        "PAN": "Jose Raul Mulino is president, elected as Ricardo Martinelli's stand-in and now governing in his own name.",
        "COS": "Rodrigo Chaves is president, an outsider at war with the assembly and the courts.",
        "GUA": "Bernardo Arevalo is president, an anti-corruption vote that the old institutions tried to stop.",
        "HON": "Xiomara Castro is president. Libre holds the executive in a country whose last government extradited a president.",
        "NIC": "Daniel Ortega is president, with Rosario Murillo beside him. The opposition is in exile or in prison.",
        "ELS": "Nayib Bukele is president, re-elected outside the old term limit, on the back of the gang crackdown.",
        "ICE": "Kristrun Frostadottir is prime minister of a broad coalition after the volcanic and inflation years.",
        "LUX": "Luc Frieden is prime minister, returning the CSV to the head of a coalition government.",
        "MLT": "Robert Abela is prime minister. Labour has held Malta long enough that the party and the ministries overlap.",
        "CYP": "Nikos Christodoulides is president, elected between the two old parties and still stuck on the UN talks.",
        "NCY": "Ersin Tatar presides over Northern Cyprus. Ankara is the patron. Recognition is the missing piece.",
        "UAE": "Mohamed bin Zayed is president. Abu Dhabi, not the federal cabinet, decides foreign policy and the sovereign funds.",
        "QAT": "Tamim bin Hamad is emir. Gas revenue and mediation are the state's two instruments.",
        "KUW": "Mishal Al-Ahmad is emir. The assembly is a recurring argument he can dissolve.",
        "OMA": "Haitham bin Tariq is sultan. The succession was quiet, and so is the foreign policy.",
        "YEM": "Rashad al-Alimi heads the Presidential Leadership Council, the recognized government. It does not hold Sanaa.",
        "HOU": "Mahdi al-Mashat heads the Houthi political council in Sanaa. Abdul-Malik al-Houthi remains the movement's leader.",
        ...
        "STC": "Aidarus al-Zubaidi leads the Southern Transitional Council from Aden, a southern state project inside the anti-Houthi camp.",
        "BHR": "Hamad bin Isa is king. The Khalifa family, and Saudi support, are the government.",
        "NZL": "Christopher Luxon is prime minister of a three-party coalition of the right.",
        "PNG": "James Marape is prime minister, holding a fluid parliamentary majority in a country of many loyalties.",
        "FIJ": "Sitiveni Rabuka is prime minister, a former coup leader now heading an elected coalition.",
        "LIB": "Joseph Boakai is president, a narrow winner over George Weah, inheriting a weak state and a lively legislature.",
        "SIE": "Julius Maada Bio is president. The election that returned him is still the opposition's grievance.",
        "GNA": "Mamady Doumbouya is the junta's president. The transition's end date has already slipped.",
        "GNB": "Umaro Sissoco Embalo is president in a system where the army has usually been the final voter.",
        "GAM": "Adama Barrow is president, still in office past the transition he was elected to finish.",
        "MRT": "Mohamed Ould Ghazouani is president, a general who came in by election and governs with the security establishment.",
        "NMB": "Netumbo Nandi-Ndaitwah is president, SWAPO's first woman in the office of a party that has not lost a national election.",
        "BOT": "Duma Boko is president, the first opposition victory over the party that had governed since independence.",
        "ZAM": "Hakainde Hichilema is president, elected against the Patriotic Front and still restructuring the debt.",
        "MLW": "Lazarus Chakwera is president. The coalition is thinner than the victory that brought it in.",
        "MAD": "Andry Rajoelina is president, returned by an election the opposition partly boycotted.",
        "GAB": "Brice Oligui Nguema is president, the general who removed the Bongos and then stood for election.",
        "RCG": "Denis Sassou Nguesso is president, as he has been for most of the years since 1979.",
        "CAR": "Faustin-Archange Touadera is president. Russian contractors and Rwandan troops are part of how Bangui stays his.",
        "EQG": "Teodoro Obiang has been president since 1979. Oil and the family are the state.",
        "TOG": "Faure Gnassingbe is president, his father's successor. The dynasty is the constitution that matters.",
        "DAH": "Patrice Talon is president, a cotton magnate who tightened the presidency and sidelined the old opposition.",
        "VOL": "Ibrahim Traore leads the Burkinabe junta. The captain is young. The war with the jihadists is not.",
        "ERI": "Isaias Afwerki is president. There has not been an election, and the army is the institution.",
        "DJI": "Ismail Omar Guelleh is president. The foreign bases, not the electorate, pay for the state.",
        "BRD": "Evariste Ndayishimiye is president, the ruling party's choice after Nkurunziza.",
        "TML": "Jose Ramos-Horta is president. The prime minister runs the day-to-day, and the oil fund is what they argue over.",
        "BRN": "Hassanal Bolkiah is sultan and prime minister. The oil state and the monarchy are the same thing.",
        "MLD": "Mohamed Muizzu is president, elected on an India-out line and now bargaining with both Delhi and Beijing.",
        "BAH": "Philip Davis is prime minister. The PLP holds a tourism economy that lives on American visitors.",
        "JAM": "Andrew Holness is prime minister, re-elected, with crime as the constraint that does not go away.",
        "GYA": "Irfaan Ali is president. The oil is new. The border case with Venezuela is not.",
        "BLZ": "Johnny Briceno is prime minister. The old party's long run is over. Guatemala's claim is not.",
        "TRI": "Kamla Persad-Bissessar is prime minister, back at the head of the UNC.",
        "ATG": "Gaston Browne is prime minister. Labour has held the state through hurricane seasons and arguments over citizenship for sale.",
        "DMA": "Roosevelt Skerrit is prime minister, as he has been since 2004. Labour and the state have grown together.",
        "STL": "Philip J Pierre is prime minister, leading Labour after the last term of the opposition.",
        "SVG": "Ralph Gonsalves is prime minister, the long incumbent of the Unity Labour Party.",
        "GND": "Dickon Mitchell is prime minister, ending the New National Party's run.",
        "BRB": "Mia Mottley is prime minister, with a majority large enough that the opposition is a spectator.",
        "SUR": "Jennifer Geerlings-Simons is president of a coalition in a country whose oil future is larger than its politics.",
        "CRC": "Gilmar Pisas leads Curacao, a small autonomous country inside the Dutch kingdom.",
        "CBV": "Jose Maria Neves is president of Cabo Verde, a stable Atlantic democracy with very little margin.",
        "BAS": "This tag is unused. The Lesser Antilles have no separate government in 2026.",
        "KIR": "Taneti Maamau is president. Recognition of Beijing, and the sea, are the two foreign-policy facts.",
        "TUV": "Feleti Teo is prime minister of a country arguing over how long its land stays above the water.",
        "NAU": "David Adeang is president. The phosphate is gone. Recognition deals remain.",
        "MHL": "Hilda Heine is president. The compact with the United States is both the budget and the security policy.",
        "MAU": "Navin Ramgoolam is prime minister again, returned against the party that had governed since 2014.",
        "COM": "Azali Assoumani is president, a former coup leader who has since preferred elections he wins.",
        "STP": "Carlos Vila Nova is president. The prime minister runs the government of two small islands and a debt.",
        "SEY": "Wavel Ramkalawan is president, the first opposition leader to take the office from the old ruling party.",
        "YUG": "This tag is unused. There is no Yugoslav government in 2026.",
        "ADU": "Andalusia has no separate government in January 2026.",
        "AFA": "Afar has no separate government in January 2026.",
        "ALT": "Altai Republic has no separate government in January 2026.",
        "ANU": "Ainu has no separate government in January 2026.",
        "AOI": "Italian East Africa has no separate government in January 2026.",
        "ASY": "Assyria has no separate government in January 2026.",
        "ATJ": "Atjeh has no separate government in January 2026.",
        "BAR": "Barotseland has no separate government in January 2026.",
        "BAY": "Bavaria has no separate government in January 2026.",
        "BEG": "Benishangul-Gumuz has no separate government in January 2026.",
        "BIA": "Biafra has no separate government in January 2026.",
        "BLC": "Balochistan has no separate government in January 2026.",
        "BLI": "Bali has no separate government in January 2026.",
        "BOU": "Bougainville has no separate government in January 2026.",
        "BRI": "Brittany has no separate government in January 2026.",
        "BSK": "Bashkortostan has no separate government in January 2026.",
        "BUK": "Bukharan Republic has no separate government in January 2026.",
        "BYA": "Buryatia has no separate government in January 2026.",
        "CAT": "Catalonia has no separate government in January 2026.",
        "CAY": "Cayenne has no separate government in January 2026.",
        "CHM": "Champa has no separate government in January 2026.",
        "CHR": "Charrua has no separate government in January 2026.",
        "CHU": "Chuvashia has no separate government in January 2026.",
        "CIN": "Chechnya-Ingushetia has no separate government in January 2026.",
        "CIP": "Central Indian Provinces has no separate government in January 2026.",
        "CKK": "Chukotka has no separate government in January 2026.",
        "COR": "Corsica has no separate government in January 2026.",
        "CPS": "Champasak has no separate government in January 2026.",
        "CRI": "Crimea has no separate government in January 2026.",
        "CSA": "CSA has no separate government in January 2026.",
        "DAG": "Dagestan has no separate government in January 2026.",
        "DDR": "East Germany has no separate government in January 2026.",
        "DIP": "Partisans has no separate government in January 2026.",
        "DNZ": "Danzig has no separate government in January 2026.",
        "DON": "Don Republic has no separate government in January 2026.",
        "EVE": "Evenkia has no separate government in January 2026.",
        "EZO": "Ezo Republic has no separate government in January 2026.",
        "FER": "Far Eastern Republic has no separate government in January 2026.",
        "FSA": "Federation of South Arabia has no separate government in January 2026.",
        "FSM": "Micronesia has no separate government in January 2026.",
        "GAL": "Galicia and Lodomeria has no separate government in January 2026.",
        "GAR": "Guarani has no separate government in January 2026.",
        "GBA": "Gambela has no separate government in January 2026.",
        "GDC": "Guangdong has no separate government in January 2026.",
        "GDL": "Guadeloupe has no separate government in January 2026.",
        "GEN": "Generalgouvernement has no separate government in January 2026.",
        "GLC": "Galicia has no separate government in January 2026.",
        "GOW": "Gowa has no separate government in January 2026.",
        "GSM": "Gansu Ma has no separate government in January 2026.",
        "GUM": "Guam has no separate government in January 2026.",
        "GXC": "Guangxi has no separate government in January 2026.",
        "HAN": "Hanover has no separate government in January 2026.",
        "HAR": "Harar has no separate government in January 2026.",
        "HAW": "Hawaii has no separate government in January 2026.",
        "HBC": "Hebei-Chahar has no separate government in January 2026.",
        "HES": "Hesse has no separate government in January 2026.",
        "HRZ": "Herzegovina has no separate government in January 2026.",
        "HYD": "Hyderabad has no separate government in January 2026.",
        "IAS": "Isthmo Amerindia has no separate government in January 2026.",
        "IG1": "Doomsday Insurgent 1 has no separate government in January 2026.",
        "IG2": "Doomsday Insurgent 2 has no separate government in January 2026.",
        "IG3": "Doomsday Insurgent 3 has no separate government in January 2026.",
        "IG4": "Doomsday Insurgent 4 has no separate government in January 2026.",
        "IMO": "Omani Imamate has no separate government in January 2026.",
        "INC": "Inca has no separate government in January 2026.",
        "INU": "Inuit has no separate government in January 2026.",
        "ITZ": "Itza has no separate government in January 2026.",
        "JAN": "Jan Mayen has no separate government in January 2026.",
        "KAL": "Kalmykia has no separate government in January 2026.",
        "KAR": "Karelia has no separate government in January 2026.",
        "KAS": "Kashmir has no separate government in January 2026.",
        "KAT": "Katanga has no separate government in January 2026.",
        "KBK": "Kabardino-Balkaria has no separate government in January 2026.",
        "KHA": "Khakassia has no separate government in January 2026.",
        "KHI": "Khiva has no separate government in January 2026.",
        "KHL": "Khalistan has no separate government in January 2026.",
        "KHM": "Khotan Ma has no separate government in January 2026.",
        "KKP": "Karakalpakstan has no separate government in January 2026.",
        "KLT": "KLT -Kalat has no separate government in January 2026.",
        "KOL": "Kolhapur and Deccan States has no separate government in January 2026.",
        "KOM": "Komi Republic has no separate government in January 2026.",
        "KSH": "Kashubia has no separate government in January 2026.",
        "KUB": "Kuban Republic has no separate government in January 2026.",
        "KUM": "Kumul Khanate has no separate government in January 2026.",
        "LBV": "Lombardy Venetia has no separate government in January 2026.",
        "MAN": "Manchukou has no separate government in January 2026.",
        "MAY": "Maya has no separate government in January 2026.",
        "MEK": "Mecklenburg has no separate government in January 2026.",
        "MEL": "Mari El has no separate government in January 2026.",
        "MEN": "Mengkukuo has no separate government in January 2026.",
        "MIS": "Miskito has no separate government in January 2026.",
        "MPU": "Manipur has no separate government in January 2026.",
        "MYS": "Mysore has no separate government in January 2026.",
        "NAH": "Nahua has no separate government in January 2026.",
        "NAV": "Navarra has no separate government in January 2026.",
        "NEN": "Nenetsia has no separate government in January 2026.",
        "NIR": "Northern Ireland has no separate government in January 2026.",
        "NOA": "North Ossetia-Alania has no separate government in January 2026.",
        "NWF": "North Western Frontier States has no separate government in January 2026.",
        "NXM": "Ningxia Ma has no separate government in January 2026.",
        "OCC": "Occitania has no separate government in January 2026.",
        "OKN": "Okinawa has no separate government in January 2026.",
        "ORO": "Oromo has no separate government in January 2026.",
        "OVO": "Ostyakia Vogulia has no separate government in January 2026.",
        "PAP": "Papal States has no separate government in January 2026.",
        "PLU": "Palau has no separate government in January 2026.",
        "POK": "Pontianak has no separate government in January 2026.",
        "PRC": "ComChina has no separate government in January 2026.",
        "PRE": "Prussia has no separate government in January 2026.",
        "PSH": "Pashtunistan has no separate government in January 2026.",
        "PSR": "Philippine Second Republic has no separate government in January 2026.",
        "PUE": "Puerto Rico has no separate government in January 2026.",
        "QEM": "Qemant has no separate government in January 2026.",
        "QUE": "Quebec has no separate government in January 2026.",
        "RAA": "Reichskommisariat Australasien has no separate government in January 2026.",
        "RAN": "Reichskommisariat Anden has no separate government in January 2026.",
        "RAP": "Rapa Nui has no separate government in January 2026.",
        "RAR": "Reichskommisariat Arabien has no separate government in January 2026.",
        "RAS": "Madras States has no separate government in January 2026.",
        "RCO": "Reichskommisariat Kolumbus has no separate government in January 2026.",
        "RGB": "Reichskommisariat Grossbritannien has no separate government in January 2026.",
        "RHD": "Reichskommisariat Grosshindustan has no separate government in January 2026.",
        "RHI": "Rhineland has no separate government in January 2026.",
        "RIF": "Rif has no separate government in January 2026.",
        "RIG": "Rio Grande has no separate government in January 2026.",
        "RJP": "Rajputana has no separate government in January 2026.",
        "RKA": "Reichskommisariat Mittelafrika has no separate government in January 2026.",
        "RKB": "Reichskommisariat Belgien has no separate government in January 2026.",
        "RKC": "Reichskommisariat Balkan has no separate government in January 2026.",
        "RKG": "Reichskommisariat Norwegen has no separate government in January 2026.",
        "RKH": "Bohmen Mahren has no separate government in January 2026.",
        "RKI": "Reichskommisariat Iberien has no separate government in January 2026.",
        "RKK": "Reichskommisariat Kaukasien has no separate government in January 2026.",
        "RKL": "Reichskommisariat Urals has no separate government in January 2026.",
        "RKM": "Reichskommisariat Moskowien has no separate government in January 2026.",
        "RKN": "Reichskommisariat Niederlande has no separate government in January 2026.",
        "RKO": "Reichskommisariat Ostland has no separate government in January 2026.",
        "RKT": "Reichskommisariat Turkestan has no separate government in January 2026.",
        "RKU": "Reichskommisariat Ukraine has no separate government in January 2026.",
        "RKV": "Reichskommisariat Klein Venedig has no separate government in January 2026.",
        "RNA": "Reichskommisariat Nordafrika has no separate government in January 2026.",
        "RNG": "Reorganized National Government has no separate government in January 2026.",
        "ROA": "Reichskommisariat Ostasien has no separate government in January 2026.",
        "RUS": "Reichskommisariat Nordamerika has no separate government in January 2026.",
        "RUT": "Ruthenia has no separate government in January 2026.",
        "SAB": "Sabah has no separate government in January 2026.",
        "SAM": "Samoa has no separate government in January 2026.",
        "SAR": "Sarawak has no separate government in January 2026.",
        "SAX": "Saxony has no separate government in January 2026.",
        "SCO": "Scotland has no separate government in January 2026.",
        "SDL": "Sudetenland has no separate government in January 2026.",
        "SHL": "Schleswig-Holstein has no separate government in January 2026.",
        "SHX": "Shanxi has no separate government in January 2026.",
        "SIC": "Sichuan has no separate government in January 2026.",
        "SID": "Sidamo has no separate government in January 2026.",
        "SIK": "Sinkiang has no separate government in January 2026.",
        "SIL": "Silesia has no separate government in January 2026.",
        "SIN": "Sindh has no separate government in January 2026.",
        "SKK": "Sikkim has no separate government in January 2026.",
        "SMI": "Sami has no separate government in January 2026.",
        "SND": "Shandong has no separate government in January 2026.",
        "SOK": "Sokoto has no separate government in January 2026.",
        "SOL": "Solomon Islands has no separate government in January 2026.",
        "SPM": "Sardinia Piedmont has no separate government in January 2026.",
        "SSI": "Siak has no separate government in January 2026.",
        "TAH": "Tahiti has no separate government in January 2026.",
        "TAN": "Tannu Tuva has no separate government in January 2026.",
        "TAT": "Tatarstan has no separate government in January 2026.",
        "TAY": "Taymyria has no separate government in January 2026.",
        "THU": "Thuringia has no separate government in January 2026.",
        "TIB": "Tibet has no separate government in January 2026.",
        "TIG": "Tigray has no separate government in January 2026.",
        "TNE": "Ternate has no separate government in January 2026.",
        "TOS": "Tuscany has no separate government in January 2026.",
        "TRA": "Transylvania has no separate government in January 2026.",
        "TTS": "The Two Sicilies has no separate government in January 2026.",
        "UBD": "United Baltic Duchy has no separate government in January 2026.",
        "UDM": "Udmurtia has no separate government in January 2026.",
        "USB": "USB has no separate government in January 2026.",
        "VAN": "Vanuatu has no separate government in January 2026.",
        "VGE": "Volga Germany has no separate government in January 2026.",
        "VLA": "Vladivostok has no separate government in January 2026.",
        "WGR": "West Germany has no separate government in January 2026.",
        "WIS": "Western Indian States has no separate government in January 2026.",
        "WLA": "Welsh Argentina has no separate government in January 2026.",
        "WLS": "Wales has no separate government in January 2026.",
        "WPG": "West Papua has no separate government in January 2026.",
        "WUR": "Wurtemberg has no separate government in January 2026.",
        "XIC": "Xi'An has no separate government in January 2026.",
        "XSM": "Xibei San Ma has no separate government in January 2026.",
        "YAK": "Yakutia has no separate government in January 2026.",
        "YAM": "Yamalia has no separate government in January 2026.",
        "YUC": "Yucatan has no separate government in January 2026.",
        "YUN": "Yunnan has no separate government in January 2026.",
    }
